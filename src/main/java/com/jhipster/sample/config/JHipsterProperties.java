...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "jHipsterSample@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "jHipsterSample API";

        private String description = "jHipsterSample API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "jHipsterSample";
